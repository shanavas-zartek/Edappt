                ...
                <div class="card-body">
                  ...
                  <form method="POST" id="optionpollForm" action="javascript:void(0)" >
                    ...
                    <div class="form-group">
                     ...
                     <input type="text" id="question" name="question" class="form-control" value="{{$edit->question}}">
...
@foreach($option_answers as $row)
  ...
  <tr>
                            <td> <input type="text" name="answer[]" id="answer<?= $i  ?>" class="form-control answer" value="  {{$row->answer }} " >
                              <span class="mandatory_sign" name="answer"></span>
                            </td>
