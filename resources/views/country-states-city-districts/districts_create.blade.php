            ...
            <div class="col-12 grid-margin">
              <div class="card col-9">
                <div class="card-body">
                  ...
                  <form method="POST" id="form1" action="{{ route('district.store')}}"  >
                    @csrf  
                    <input type="hidden" class="form-control" @if(isset($edit->id)) value="{{$edit->id}}" @endif name="district_id"  />
                    ...
                    <input type="hidden"   value="{{ route('district.index')}}"   id="hdn_url" name="hdn_url"  />
