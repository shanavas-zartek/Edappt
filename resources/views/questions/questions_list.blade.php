...
<div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
                ...
                <a href="{{ route('questions.create')}}" class="btn btn-primary btn-rounded btn-fw float-right">ADD</a>
</br>
</br>
              ...
              <tr>
                ...
                @if(!empty($row->start_date))
                  ...
                  <td><a href="{{URL::to('subscription/delete/'.$row->id) }}" data-toggle="tooltip" title="delete" class="btn btn-sm btn-danger">Delete </a></td>
                </tr>
               <?php $i++; ?>
                @endforeach
              @endif
