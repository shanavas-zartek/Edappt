            ...
            <div class="col-lg-12 grid-margin stretch-card">
              ...
              <tr>
                <td>{{$i}}</td>
                  ...
                  <td><a href="{{URL::to('teacher/delete_teacherdemand/'.$row->id) }}" onclick="return confirm_click();" data-toggle="tooltip" title="delete" class="btn btn-sm btn-danger">Delete </a></td>
                </tr>
               <?php $i++; ?>
                @endforeach
              @endif
