...
<div class="main-panel">
          ...
          <div class="col-12 grid-margin">
              <div class="card col-9">
                <div class="card-body">
                  <h4 class="card-title">L&D Category
</h4>
                  <form method="POST" id="form1" action="{{ route('learning.store')}}" enctype="multipart/form-data">
                    @csrf  
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="category" id="category" placeholder="Category Name" @if(isset($edit->category)) value="{{$edit->category}}" @endif  />
                ...
                @error('status')<span class="mandatory_sign">{{ $message }}</span>@enderror
                    ...
                    <input type="hidden"   value="{{ route('learning.index')}}"   id="hdn_url" name="hdn_url"  />
