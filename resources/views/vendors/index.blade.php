            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  ...
                  <div class="flash-message">
                    ...
                    <a href="{{URL::to('vendors/create/0') }}" class="btn btn-primary btn-rounded btn-fw float-right">ADD</a>
                <!-- <a href="{{ route('vendors.create')}}" class="btn btn-primary btn-rounded btn-fw float-right">ADD</a> -->
</br>
</br>
